...
adminRoute.get(
  "/addCategory",
  adminAuth.isLogin,
  categoryController.loadCategoryform
);
adminRoute.post(
  "/addCategory",
...
adminRoute.get(
  "/addproduct",
  adminAuth.isLogin,
  productController.loadPorductForm
);
adminRoute.post(
  "/addproduct",
...
adminRoute.get(
  "/editProduct",
  adminAuth.isLogin,
  productController.loadEditPorductForm
);
adminRoute.get(
  "/deleteProduct/:id",
  adminAuth.isLogin,
...
adminRoute.post(
  "/editProduct",
  multer.uploadProduct.array("image"),
  productController.storeEditProduct
);
...
adminRoute.get(
  "/couponList",
  adminAuth.isLogin,
  couponController.loadCouponList
);
adminRoute.get(
  "/couponEdit",
  adminAuth.isLogin,
